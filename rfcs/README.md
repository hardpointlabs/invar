...
Invar's RFC process is inspired by [thecoderift/rfc](https://github.com/thecodedrift/rfc/blob/master/README.md)'s RFC template.

That work was in turn inspired by the Rust RFC Process and IETF RFC3 "Documentation Conventions".

As with the rest of the contents of this project, all RFCs are released under the [Apache License, Version 2.0](http://www.apache.org/licenses/LICENSE-2.0).